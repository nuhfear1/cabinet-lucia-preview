...
Permettre une livraison rapide du site public sans inventer d'informations professionnelles ou médicales, sans imposer de photo de Lucia Cespedes-Ocampo et sans modifier le fonctionnement entre le site public et le backend.
...
4. présenter le cabinet opérationnel de Morne-à-l’Eau et sa photo validée ;
...
9. conserver les mentions légales et ne jamais inventer ou déduire une donnée absente.
